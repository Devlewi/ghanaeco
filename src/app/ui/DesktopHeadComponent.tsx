...
const villeAleatoire =
  villesGhana[Math.floor(Math.random() * villesGhana.length)];

console.log(villeAleatoire);
  ...
  const options: Intl.DateTimeFormatOptions = {
    ...
    month: "long",
    year: "numeric",
    timeZone: "Africa/Accra", // Force le fuseau horaire du Ghana
  };
  ...
  const currentDate = `${villeAleatoire}, on ${dateFormattee}`;
  ...
  // Format date en "June 04, 2025"
  const formattedDate = date.toLocaleDateString("en-US", options);

  // Heures et minutes format "03:54 PM" ou "15:54"
  const hours = date.getHours();
  const minutes = date.getMinutes();
  const ampm = hours >= 12 ? 'PM' : 'AM';
  const displayHours = hours % 12 || 12; // Format 12h
    ...
    <>
      <Head>
        <link
          rel="preload"
          as="image"
          href={`/${locale}/images/banner-ghana.webp`}
          type="image/webp"
...
>
        ...
        <div
          ...
          style={{
            background: `url(/${locale}/images/banner-ghana.webp) center center / cover no-repeat`,
                  ...
                  <ul id="menu-top-links" className="menu">
                    ...
                    >
                      <a href="#" style={{ fontWeight: 900, fontSize: 15 }}>
                        <img
                          src={`/${locale}/images/flag-ghana.webp`}
                          style={{ width: "20%" }}
                          alt="drapeau Nigeria"
                          className="mr-2"
                        />
          ...
          <div className="inner full">
            ...
            <div className="items items-center ">
              ...
              >
                <h1>
                  <img
                    src={`/${locale}/images/logo-ghana-eco.webp`}
                    className="logo-image logo-image-dark"
                    alt=""
                    srcSet={`/${locale}/images/logo-ghana-eco.webp`}
                  />
