          ...
          >
            ...
            >
              <span className="date-link">
                <time
  className="post-date"
  // On utilise la ternaire pour s'assurer que si la date est absente, 
  // on envoie 'undefined' et non 'false' ou 'null'
  dateTime={articleEmplacement3?.date ? articleEmplacement3.date : undefined}
  style={{
    color: "#1a2a54",
    fontWeight: 600,
  }}
