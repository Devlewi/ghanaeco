          ...
          <div className="post-meta-items meta-below">
            ...
            >
              <span className="date-link">
                <time
  className="post-date"
  // On s'assure que si la date n'existe pas, on passe undefined (ce qui supprime l'attribut du DOM)
  // et non une valeur vide ou un booléen.
  dateTime={articleEmplacement1?.date ? String(articleEmplacement1.date) : undefined}
  style={{ color: "#1a2a54", fontWeight: 600 }}
>
  {t.publishedAt}{" "}
  <span style={{ color: "#db2e44" }}>
    {articleEmplacement1?.date ? (
