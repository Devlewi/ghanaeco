      ...
      <div className="block-content">
        <div className="loop loop-grid loop-grid-sm grid grid-5 md:grid-2 xs:grid-1">
          <article className="l-post grid-post grid-sm-post">
            <div className="text-content">
              <div className="post-meta post-meta-a has-below">
                <h2 className="uppercase" style={{ fontSize: 18, fontWeight: 800 }}>{menu.generalnews}</h2>
                <ul>
          ...
          <article className="l-post grid-post grid-sm-post">
            <div className="text-content">
              <div className="post-meta post-meta-a has-below">
                <h2 className="uppercase" style={{ fontSize: 18, fontWeight: 800 }}>{menu.businessnews}</h2>
                <ul>                  
                </ul>
              </div>
            </div>
          ...
          <article className="l-post grid-post grid-sm-post">
            <div className="text-content">
              <div className="post-meta post-meta-a has-below">
                <h2 className="uppercase" style={{ fontSize: 18, fontWeight: 800 }}>{menu.financialmarket}</h2>
                <ul>
                  <li>
          ...
          <article className="l-post grid-post grid-sm-post">
            <div className="text-content">
              <div className="post-meta post-meta-a has-below">
                ...
                {he.decode(menu.businessector)}
                </h2>
                <ul>
                  <li>
                    <Link href={`/${locale}/${categoryPath}/${slugs.distribution}`} style={{ color: "#fff", fontWeight: 700, fontSize:15  }}>
                    {menu.distribution}
                    </Link>
                  </li>
                  <li>
                    <Link href={`/${locale}/${categoryPath}/${slugs.services}`} style={{ color: "#fff", fontWeight: 700, fontSize:15  }}>
                    {menu.services}
                    </Link>
                  </li>                  
                  <li>
                    <Link href={`/${locale}/${categoryPath}/${slugs.transportation}`} style={{ color: "#fff", fontWeight: 700, fontSize:15  }}>
                    {menu.transportation}
                    </Link>
                  </li>                  
                  <li>
                    <Link href={`/${locale}/${categoryPath}/${slugs.energy}`} style={{ color: "#fff", fontWeight: 700, fontSize:15  }}>
                    {menu.energy}
                    </Link>
                  </li>                  
                  <li>
                    <Link href={`/${locale}/${categoryPath}/${slugs.media}`} style={{ color: "#fff", fontWeight: 700, fontSize:15  }}>
                    {menu.media}
                    </Link>
                  </li>                  
                  <li>
                  ...
                  <li>
                    <Link href={`/${locale}/${categoryPath}/${slugs.oilandgas}`} style={{ color: "#fff", fontWeight: 700, fontSize:15  }}>
                    {menu.oilandgas}
                    </Link>
                  </li>                  
                  <li>
                    <Link href={`/${locale}/${categoryPath}/${slugs.finance}`} style={{ color: "#fff", fontWeight: 700, fontSize:15  }}>
                    {menu.finance}
                    </Link>
                  </li>                  
                  <li>
          ...
          <article className="l-post grid-post grid-sm-post">
            <div className="text-content">              
              <div className="post-meta post-meta-a has-below">
                <Link href={`/${locale}/${categoryPath}/${slugs.successtories}`}>
                  <h2 style={{ fontSize: 18, fontWeight: 800 }} className="uppercase">
                  {he.decode(menu.successtories)}
                  </h2>                
                </Link>
              </div>
              <div className="post-meta post-meta-a has-below">
                <Link href={`/${locale}/${categoryPath}/${slugs.trends}`}>
                  <h2 style={{ fontSize: 18, fontWeight: 800 }} className="uppercase">
                  {he.decode(menu.trends)}
                  </h2>                
                </Link>
              </div>
              <div className="post-meta post-meta-a has-below">
                <Link href={`/${locale}/${categoryPath}/${slugs.opinions}`}>
                  <h2 style={{ fontSize: 18, fontWeight: 800 }} className="uppercase">
 ...
 >
  ...
  >
    ...
    <div className="footer-legal-links" style={{ display: "flex", gap: 10, flexWrap: "wrap", alignItems: "center", justifyContent: "center" }}>
          <span style={{ color: "white", fontWeight: 800 }}>© 2025 Ghana Eco</span>
          <span>|</span>
