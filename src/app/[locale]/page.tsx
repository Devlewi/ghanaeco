...
export async function generateMetadata({
  ...
  return {
    title: locale === "en" ? "GHANA-ECO | HOME" : "GHANA-ECO | ACCUEIL",
    description:
      locale === "en"
        ? "GHANA-ECO, your economic news portal dedicated to Ghana."
        : "GHANA-ECO, votre portail d’information économique de référence au Ghana.",
